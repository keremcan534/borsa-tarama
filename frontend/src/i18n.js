...
const STRINGS = {
  tr: {
    ...
    pfIntro:
      'Fon alımlarını gir, güncel pay değeriyle kâr/zararını takip et. Veriler yalnızca bu tarayıcıda saklanır.',
    pfFund: 'Fon',
    ...
    pfErrUnknown: (s) => `${s} taranan fonlar arasında yok; kodu kontrol et.`,
  ...
  en: {
    ...
    pfIntro:
      'Enter your fund purchases and track profit/loss against the latest NAV. Data is stored only in this browser.',
    pfFund: 'Fund',
    ...
    pfErrUnknown: (s) => `${s} is not among the scanned funds; check the code.`,
