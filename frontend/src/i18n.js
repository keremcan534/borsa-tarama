...
const STRINGS = {
  tr: {
    ...
    todayNewSignals: 'Bugünün yeni sinyalleri',
    todayNewSignalsEmpty:
      'Bugün yeni sinyal yok — listedekiler önceki taramadan beri kriterleri sağlamaya devam ediyor.',
  ...
  en: {
    ...
    todayNewSignals: "Today's new signals",
    todayNewSignalsEmpty:
      'No new signals today — the listed names have kept meeting the criteria since the previous scan.',
